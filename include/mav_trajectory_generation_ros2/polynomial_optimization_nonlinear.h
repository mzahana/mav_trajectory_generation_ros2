...
struct NonlinearOptimizationParameters {
  ...
  nlopt_algorithm algorithm = NLOPT_LN_BOBYQA;
...
struct OptimizationInfo {
  int n_iterations = 0;
  int stopping_reason = NLOPT_FAILURE;
...
class PolynomialOptimizationNonLinear {
 ...
 private:
  ...
  std::shared_ptr<nlopt_opt> nlopt_;
...
#include "mav_trajectory_generation_ros2/impl/polynomial_optimization_nonlinear_impl.h"
